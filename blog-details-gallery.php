...
<!-- Mirrored from demo.hasthemes.com/petmark-v5/petmark/blog-details-gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 29 Dec 2020 05:36:31 GMT -->
<head>
	<meta charset="UTF-8">
...
<section class="blog-page-section with-sidebar">
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-xl-9 mb--60">
				<div class="blog-post post-details  left-slide-margin">
					
					<div class="blog-post post-details single-block">
    
    
        <div class="blog-image-gallery petmark-slick-slider" data-slick-setting='{
        					                            "autoplay": true,
        					                            "autoplaySpeed": 3000,
        					                            "slidesToShow": 1,
        					                            "arrows": true
        																	}'>
            <img src="image/others/blog-slider-1.jpg" alt="">
            <img src="image/others/blog-slider-2.jpg" alt="">
            <img src="image/others/blog-slider-3.jpg" alt="">
...
<div class="replay-form-wrapper single-block">
    ...
    <form action="https://demo.hasthemes.com/petmark-v5/petmark/" class="blog-form">
  <div class="row">
    <div class="col-12">
        ...
        <a href="#" class="btn btn-black">Post Comment</a>
					...
					<div class="blog-content mt--30">
						<header>
							...
							<h3 class="blog-title"> <a href="blog-details.html">Blog Gllery post </a></h3>
							<div class="post-meta">
								<span class="post-author">
									<i class="fas fa-user"></i>
									<span class="text-gray">Posted by : </span>
						...
						<article>
							...
							<p class="p-0">Donec vitae hendrerit arcu, sit amet faucibus nisl. Cras pretium arcu ex. Aenean posuere libero eu augue condimentum
							rhoncus. Praesent ornare tortor ac ante egestas hendrerit. Aliquam et metus pharetra, bibendum massa nec, fermentum
							odio. Nunc id leo ultrices, mollis ligula in, finibus tortor. Mauris eu dui ut lectus fermentum eleifend. Pellentesque
							faucibus sem ante, non malesuada odio varius nec. Suspendisse potenti.</p>

							<blockquote>
								<p>Quisque semper nunc vitae erat pellentesque, ac placerat arcu consectetur. In venenatis elit ac ultrices convallis.
									Duis est nisi, tincidunt ac urna sed, cursus blandit lectus. In ullamcorper sit amet ligula ut eleifend. Proin dictum
									tempor ligula, ac feugiat metus. Sed finibus tortor eu scelerisque scelerisque.</p>
							</blockquote>
							<p>Aenean et tempor eros, vitae sollicitudin velit. Etiam varius enim nec quam tempor, sed efficitur ex ultrices.
							Phasellus pretium est vel dui vestibulum condimentum. Aenean nec suscipit nibh. Phasellus nec lacus id arcu facilisis
							elementum. Curabitur lobortis, elit ut elementum congue, erat ex bibendum odio, nec iaculis lacus sem non lorem. Duis
							suscipit metus ante, sed convallis quam posuere quis. Ut tincidunt eleifend odio, ac fringilla mi vehicula nec. Nunc
							vitae lacus eget lectus imperdiet tempus sed in dui. Nam molestie magna at risus consectetur, placerat suscipit justo
							dignissim. Sed vitae fringilla enim, nec ullamcorper arcu.</p>
							
							<p>Suspendisse turpis ipsum, tempus in nulla eu, posuere pharetra nibh. In dignissim vitae lorem non mollis. Praesent
							pretium tellus in tortor viverra condimentum. Nullam dignissim facilisis nisl, accumsan placerat justo ultricies vel.
							Vivamus finibus mi a neque pretium, ut convallis dui lacinia. Morbi a rutrum velit. Curabitur sagittis quam quis
							consectetur mattis. Aenean sit amet quam vel turpis interdum sagittis et eget neque. Nunc ante quam, luctus et neque a,
							interdum iaculis metus. Aliquam vel ante mattis, placerat orci id, vehicula quam. Suspendisse quis eros cursus, viverra
							urna sed, commodo mauris. Cras diam arcu, fringilla a sem condimentum, viverra facilisis nunc. Curabitur vitae orci id
							nulla maximus maximus. Nunc pulvinar sollicitudin molestie.</p>
						</article>
						<footer class="blog-meta">
							<div> <a href="#">3 comments </a>/ TAGS: <a href="#">fashion</a>, <a href="#">t-shirt</a>, <a href="#">white</a></div>
				...
				<div class="related-post-block mt--40 mb--40">
					<h3>Related Post</h3>
					<div class="row">
  <div class="col-md-4 mt--30">
    <div class="related-post">
...
<div class="single-comment">
  ...
  <a href="#" class="btn btn-outlined--primary btn-rounded reply-btn">Reply</a>
				...
				<div class="replay-form-wrapper pt--25 mb--25 mb-lg-0">
						<h3>LEAVE A REPLY</h3>
					<p>Your email address will not be published. Required fields are marked *</p>
					<form action="https://demo.hasthemes.com/petmark-v5/petmark/" class="blog-form">
  <div class="row">
