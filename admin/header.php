        ...
        <header class="header fixed-top clearfix">
                ...
                <ul class="nav top-menu">
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="<?php echo $baseurl?>images/3.png"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="<?php echo $baseurl?>images/1.png"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="<?php echo $baseurl?>images/2.png"></span>
                                    <span class="subject">
            ...
            <div class="top-nav clearfix">
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img alt="" src="<?php echo $adminprofile1["image"]?>" style="width: 40px;height:40px">
                            <span class="username">  <?php echo ucfirst($_SESSION["em"]);?> </span>
                         
                        </a>
                        <ul class="dropdown-menu extended logout">
                            <li><a href="<?php echo $mainurl?>Admin"><i class=" fa fa-suitcase"></i>Profile</a></li>
                            <li><a href="#"><i class="fa fa-cog"></i> Settings</a></li>
                            <li> <a href="<?php echo $mainurl?>?lggout" onclick="return confirm('Are You sure to Logout as Admin ?')">
