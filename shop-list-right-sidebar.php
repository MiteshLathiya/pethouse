...
<!-- Mirrored from demo.hasthemes.com/petmark-v5/petmark/shop-list-right-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 29 Dec 2020 05:36:29 GMT -->
<head>
	<meta charset="UTF-8">
...
<div class="shop-product-wrap list with-pagination row border grid-four-column  mr-0 ml-0 no-gutters">
  <div class="col-lg-3 col-sm-6">
    <div class="pm-product product-type-list  ">
      ...
      <div class="content">
        <h3 class="font-weight-500"><a href="product-details.html">Convallis quam sit</a></h3>
