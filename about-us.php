      ...
      <div class="row">
        <div class="col-12">
          <div class="img-box about-img-2 text-center">
            <img src="<?php echo $baseurl?>image/others/about-us-sec-3.jpg" alt="about image">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container-fluid p-0">
      <div class="row no-gutters">
        <div class="col-lg-3 col-sm-6">
          <div class="fact">
            <div class="fact__icon">
              <img src="<?php echo $baseurl?>image/icon-logo/about-us-icon1.png" alt="about icon">
            </div>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="fact">
            <div class="fact__icon">
              <img src="<?php echo $baseurl?>image/icon-logo/about-us-icon2.png" alt="about icon">
            </div>
            <div class="fact__content">
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="fact">
            <div class="fact__icon">
              <img src="<?php echo $baseurl?>image/icon-logo/about-us-icon3.png" alt="about icon">
            </div>
            <div class="fact__content">
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="fact">
            <div class="fact__icon">
              <img src="<?php echo $baseurl?>image/icon-logo/about-us-icon4.png" alt="about icon">
            </div>
            <div class="fact__content">
      ...
      <div class="row align-items-center no-gutters">
        ...
        <div class="col-xl-6 order-1 order-xl-2">
          <div class="img-box text-center">
            <img src="<?php echo $baseurl?>image/others/about-us-sec-4.jpg" alt="about image" class="d-block w-100">
          </div>
        </div>
      </div>
    </div>
