...
<main class="section-padding shop-page-section">
    <div class="container">
        ...
        <div class="shop-product-wrap grid with-pagination row border grid-four-column  mr-0 ml-0 no-gutters">
            <?php foreach ($cproductdata as $mactdata1) {

            ?>
            <div class="col-lg-3 col-sm-6">
                <div class="pm-product  ">
                    <a href="product-details.html" class="image" tabindex="0">
                        <img src="admin/<?php echo $mactdata1["pimage"] ?>" style="width: 150px; height: 150px;" alt="">
                    </a>
                    <br> <br> <br>
                    <div class="content">
                        <h3 class="font-weight-500"><a href="product-details.html"><?php echo $mactdata1["pname"] ?></a>
                        </h3>
                        <div class="price text-red">
                            <span class="old">Rs.<?php echo $mactdata1["pprice"] ?></span>
                            <span>Rs.<?php echo $mactdata1["psprice"] ?></span>
                        </div><br>
                        ...
                        <div class="btn-block d-flex">
                           ...
                           ?>
                            <a href="<?php echo $mainurl?>Login1" class="btn btn-outlined btn-rounded btn-mid">Add
                                to Cart</a>
                            <?php }
                                       else{
                            ...
                            <a href="<?php echo $mainurl?>Cart?product_id=<?php echo $mactdata1["pid"];?>"
                                class="btn btn-outlined btn-rounded btn-mid">Add to Cart</a>
                            <?php
                                            }
                                            ?>
