...
<!-- Mirrored from demo.hasthemes.com/petmark-v5/petmark/product-details-grouped.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 29 Dec 2020 05:36:29 GMT -->
<head>
	<meta charset="UTF-8">
      ...
      <div class="row">
        ...
        <div class="col-md-6 mt-5 mt-md-0">
          <div class="description-block">
           ...
           <!-- Product group Block -->
           <div class="grouped-product-block">
            <div class="grouped-product">
              <div class="count-input-block">
                <input type="number" class="form-control text-center" value="1">
              </div>
              <div class="details">
                <h3 class="title"> <a href="product-details.html">Kaoreet lobortis</a></h3>
